...
const undo = (state, action) => pipe(set(StateLenses.fieldsState, state.fieldsStateHistory[1]), over(StateLenses.fieldsStateHistory, slice(1)))(state);
