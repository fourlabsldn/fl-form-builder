...
var ButtonGroupDropdown = function ButtonGroupDropdown(_ref2) {
  ...
  return React.createElement(
    'div',
    { className: 'fb-ControlBar-dropdown' },
    React.createElement(
      'button',
...
var getDescrition = _curry(function (fieldTypes, type) {
  var construct = fieldTypes[type];
  return {
    type: type,
...
var ControlBar = function ControlBar(_ref3) {
  ...
  var fieldGroups = Object.keys(fieldTypes).map(getDescrition(fieldTypes)).reduce(toGroups, {});
...
var validateFieldState = function validateFieldState(state) {
...
var FormBuilder$2 = function (_React$Component) {
  ...
  createClass(FormBuilder, [{
    ...
    value: function createField(fieldType) {
      assert(this.state.fieldTypes[fieldType], 'Field "' + fieldType + '" does not exist.');

      var initialState = this.fieldTypes[fieldType].initialState();
...
function FormBuilder(container) {
  ...
  ReactDOM.render(React.createElement(FormBuilder$2, { components: components }), container);
