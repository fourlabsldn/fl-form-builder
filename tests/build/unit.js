...
var require$$0$4 = (_wks && typeof _wks === 'object' && 'default' in _wks ? _wks['default'] : _wks);
...
var require$$0$3 = (_iterDetect && typeof _iterDetect === 'object' && 'default' in _iterDetect ? _iterDetect['default'] : _iterDetect);
...
var require$$1 = (core_getIteratorMethod && typeof core_getIteratorMethod === 'object' && 'default' in core_getIteratorMethod ? core_getIteratorMethod['default'] : core_getIteratorMethod);
...
var require$$0$6 = (_descriptors && typeof _descriptors === 'object' && 'default' in _descriptors ? _descriptors['default'] : _descriptors);
...
var require$$3$3 = (_isObject && typeof _isObject === 'object' && 'default' in _isObject ? _isObject['default'] : _isObject);

var _toPrimitive = __commonjs(function (module) {
// 7.1.1 ToPrimitive(input [, PreferredType])
var isObject = require$$3$3;
...
var require$$1$3 = (_domCreate && typeof _domCreate === 'object' && 'default' in _domCreate ? _domCreate['default'] : _domCreate);

var _ie8DomDefine = __commonjs(function (module) {
module.exports = !require$$0$6 && !require$$0$7(function(){
  return Object.defineProperty(require$$1$3('div'), 'a', {get: function(){ return 7; }}).a != 7;
});
});
...
var require$$1$1 = (_objectDp && typeof _objectDp === 'object' && 'default' in _objectDp ? _objectDp['default'] : _objectDp);
...
var require$$1$4 = (_toLength && typeof _toLength === 'object' && 'default' in _toLength ? _toLength['default'] : _toLength);
...
var require$$2$5 = (_hide && typeof _hide === 'object' && 'default' in _hide ? _hide['default'] : _hide);
...
var require$$0$9 = (_aFunction && typeof _aFunction === 'object' && 'default' in _aFunction ? _aFunction['default'] : _aFunction);

var _ctx = __commonjs(function (module) {
// optional / simple context binding
var aFunction = require$$0$9;
...
var require$$1$6 = (_ctx && typeof _ctx === 'object' && 'default' in _ctx ? _ctx['default'] : _ctx);
...
var ctx            = require$$1$6
  ...
  , toLength       = require$$1$4
  , createProperty = require$$2$1
  , getIterFn      = require$$1;

$export($export.S + $export.F * !require$$0$3(function(iter){ Array.from(iter); }), 'Array', {
...
var require$$2$6 = (_has && typeof _has === 'object' && 'default' in _has ? _has['default'] : _has);
...
var require$$0$14 = (_enumBugKeys && typeof _enumBugKeys === 'object' && 'default' in _enumBugKeys ? _enumBugKeys['default'] : _enumBugKeys);
...
var require$$0$15 = (_toIndex && typeof _toIndex === 'object' && 'default' in _toIndex ? _toIndex['default'] : _toIndex);
...
var require$$2$7 = (_toIobject && typeof _toIobject === 'object' && 'default' in _toIobject ? _toIobject['default'] : _toIobject);

var _arrayIncludes = __commonjs(function (module) {
// false -> Array#indexOf
// true  -> Array#includes
var toIObject = require$$2$7
  , toLength  = require$$1$4
  , toIndex   = require$$0$15;
...
var require$$1$10 = (_arrayIncludes && typeof _arrayIncludes === 'object' && 'default' in _arrayIncludes ? _arrayIncludes['default'] : _arrayIncludes);

var _objectKeysInternal = __commonjs(function (module) {
var has          = require$$2$6
  , toIObject    = require$$2$7
  , arrayIndexOf = require$$1$10(false)
  , IE_PROTO     = require$$0$11('IE_PROTO');
...
var require$$1$9 = (_objectKeysInternal && typeof _objectKeysInternal === 'object' && 'default' in _objectKeysInternal ? _objectKeysInternal['default'] : _objectKeysInternal);

var _objectKeys = __commonjs(function (module) {
// 19.1.2.14 / 15.2.3.14 Object.keys(O)
var $keys       = require$$1$9
  , enumBugKeys = require$$0$14;
...
var require$$1$8 = (_objectKeys && typeof _objectKeys === 'object' && 'default' in _objectKeys ? _objectKeys['default'] : _objectKeys);
...
require$$2$5(IteratorPrototype, require$$0$4('iterator'), function(){ return this; });
...
var require$$0$10 = (_iterDefine && typeof _iterDefine === 'object' && 'default' in _iterDefine ? _iterDefine['default'] : _iterDefine);
...
var require$$0$1 = (from$1 && typeof from$1 === 'object' && 'default' in from$1 ? from$1['default'] : from$1);

var from = __commonjs(function (module) {
module.exports = { "default": require$$0$1, __esModule: true };
});

var require$$0 = (from && typeof from === 'object' && 'default' in from ? from['default'] : from);
...
$export($export.S + $export.F * !require$$0$6, 'Object', {defineProperty: require$$1$1.f});
});
...
var require$$0$17 = (defineProperty$1 && typeof defineProperty$1 === 'object' && 'default' in defineProperty$1 ? defineProperty$1['default'] : defineProperty$1);

var defineProperty = __commonjs(function (module) {
module.exports = { "default": require$$0$17, __esModule: true };
});

var require$$0$16 = (defineProperty && typeof defineProperty === 'object' && 'default' in defineProperty ? defineProperty['default'] : defineProperty);
...
var _defineProperty = require$$0$16;
...
var require$$1$14 = (_objectGops && typeof _objectGops === 'object' && 'default' in _objectGops ? _objectGops['default'] : _objectGops);

var _objectPie = __commonjs(function (module, exports) {
exports.f = {}.propertyIsEnumerable;
});

var require$$0$21 = (_objectPie && typeof _objectPie === 'object' && 'default' in _objectPie ? _objectPie['default'] : _objectPie);

var _objectGopn = __commonjs(function (module, exports) {
// 19.1.2.7 / 15.2.3.4 Object.getOwnPropertyNames(O)
var $keys      = require$$1$9
  , hiddenKeys = require$$0$14.concat('length', 'prototype');
...
var require$$0$22 = (_objectGopn && typeof _objectGopn === 'object' && 'default' in _objectGopn ? _objectGopn['default'] : _objectGopn);

var _objectGopd = __commonjs(function (module, exports) {
var pIE            = require$$0$21
  , createDesc     = require$$5
  , toIObject      = require$$2$7
  , toPrimitive    = require$$3$2
  , has            = require$$2$6
...
var require$$1$15 = (_objectGopd && typeof _objectGopd === 'object' && 'default' in _objectGopd ? _objectGopd['default'] : _objectGopd);
...
var META     = require$$4('meta')
  , isObject = require$$3$3
  , has      = require$$2$6
  , setDesc  = require$$1$1.f
  , id       = 0;
...
if(!USE_NATIVE){
  ...
  $DP.f   = $defineProperty;
  require$$0$22.f = gOPNExt.f = $getOwnPropertyNames;
  require$$0$21.f  = $propertyIsEnumerable;
  require$$1$14.f = $getOwnPropertySymbols;
...
$Symbol[PROTOTYPE][TO_PRIMITIVE] || require$$2$5($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
module.exports = require$$0$10(Array, 'Array', function(iterated, kind){
...
var global        = require$$3
  , hide          = require$$2$5
  , Iterators     = require$$2
  , TO_STRING_TAG = require$$0$4('toStringTag');
...
var require$$0$24 = (create$1 && typeof create$1 === 'object' && 'default' in create$1 ? create$1['default'] : create$1);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = require$$1$6(Function.call, require$$1$15.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var require$$0$26 = (_setProto && typeof _setProto === 'object' && 'default' in _setProto ? _setProto['default'] : _setProto);

var es6_object_setPrototypeOf = __commonjs(function (module) {
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require$$2$4;
$export($export.S, 'Object', {setPrototypeOf: require$$0$26.set});
});
...
var require$$0$25 = (setPrototypeOf$1 && typeof setPrototypeOf$1 === 'object' && 'default' in setPrototypeOf$1 ? setPrototypeOf$1['default'] : setPrototypeOf$1);

var setPrototypeOf = __commonjs(function (module) {
module.exports = { "default": require$$0$25, __esModule: true };
});

var require$$2$8 = (setPrototypeOf && typeof setPrototypeOf === 'object' && 'default' in setPrototypeOf ? setPrototypeOf['default'] : setPrototypeOf);
...
var _setPrototypeOf = require$$2$8;
...
var require$$0$29 = (_objectSap && typeof _objectSap === 'object' && 'default' in _objectSap ? _objectSap['default'] : _objectSap);

var es6_object_getOwnPropertyDescriptor = __commonjs(function (module) {
// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
var toIObject                 = require$$2$7
  , $getOwnPropertyDescriptor = require$$1$15.f;

require$$0$29('getOwnPropertyDescriptor', function(){
...
var require$$0$28 = (getOwnPropertyDescriptor$1 && typeof getOwnPropertyDescriptor$1 === 'object' && 'default' in getOwnPropertyDescriptor$1 ? getOwnPropertyDescriptor$1['default'] : getOwnPropertyDescriptor$1);

var getOwnPropertyDescriptor = __commonjs(function (module) {
module.exports = { "default": require$$0$28, __esModule: true };
});

var require$$0$27 = (getOwnPropertyDescriptor && typeof getOwnPropertyDescriptor === 'object' && 'default' in getOwnPropertyDescriptor ? getOwnPropertyDescriptor['default'] : getOwnPropertyDescriptor);
...
require$$0$29('getPrototypeOf', function(){
...
var require$$0$30 = (getPrototypeOf$1 && typeof getPrototypeOf$1 === 'object' && 'default' in getPrototypeOf$1 ? getPrototypeOf$1['default'] : getPrototypeOf$1);
...
var _getOwnPropertyDescriptor = require$$0$27;
  ...
  componentsArray.forEach(function (ComponentContructor) {
    describe(ComponentContructor.name + ': A FormComponent subclass component should', function () {
      ...
      it('export the object without throwing', function () {
        ...
        expect(typeof state === 'undefined' ? 'undefined' : _typeof$1(state)).toEqual('object');
  ...
  componentsArray$2.forEach(function (ComponentContructor) {
    describe(ComponentContructor.name + ': A TextComponent subclass component should', function () {
      ...
      it('get and set placeholders with getPlaceholder and setPlaceholder', function () {
        expect(_typeof$1(comp.getPlaceholder)).toEqual('function');
        var initialPlaceholder = comp.getPlaceholder();
        expect(typeof initialPlaceholder === 'undefined' ? 'undefined' : _typeof$1(initialPlaceholder)).toEqual('string');

        var newPlaceholder = 'New placeholder text';
        expect(_typeof$1(comp.setPlaceholder)).toEqual('function');
...
var componentFabricSpecs = (function () {
  describe('A ComponentFabric should', function () {
    ...
    it('return the name of all components it can create with "getComponentTypes"', function () {
      expect(_typeof$1(fabric.getComponentTypes)).toBe('function');
      var types = fabric.getComponentTypes();
      expect(Array.isArray(types)).toBe(true);
      expect(types.length).toBeGreaterThan(0);
      types.forEach(function (typeName) {
        expect(typeof typeName === 'undefined' ? 'undefined' : _typeof$1(typeName)).toEqual('object');
        expect(_typeof$1(typeName.name)).toBe('string');
      });
    });
